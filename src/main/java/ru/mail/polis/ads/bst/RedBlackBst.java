...
public class RedBlackBst<Key extends Comparable<Key>, Value>
    ...
    private class Node {
        ...
        Node left;
        Node right;
        boolean colorInputLink;

        public Node(Key key, Value value, boolean colorInputLink) {
            this.key = key;
            this.value = value;
            this.colorInputLink = colorInputLink;
        }
    }
    ...
    private boolean isRed(Node x) {
        return x != null && x.colorInputLink == RED;
    }
    ...
    private Node rotateRight(Node y) {
        ...
        y.left = x.right;
        x.right = y;
        x.colorInputLink = y.colorInputLink;
        y.colorInputLink = RED;
        return x;
    }
    ...
    private Node rotateLeft(Node x) {
        ...
        x.right = y.left;
        y.left = x;
        y.colorInputLink = x.colorInputLink;
        x.colorInputLink = RED;
        return y;
    }

    private void flipColors(Node y) {
        y.colorInputLink = !y.colorInputLink;
        y.left.colorInputLink = !y.left.colorInputLink;
        y.right.colorInputLink = !y.right.colorInputLink;
    }
